...
[![Version](https://img.shields.io/badge/version-1.7.1-blue.svg)](https://github.com/yourusername/anikai-mobile/releases)
...
|------|-----------|----------|
| ![Home](screenshots/home.png) | ![Bookmarks](screenshots/bookmarks.png) | ![Settings](screenshots/settings.png) |

## 🚀 Getting Started

### Download
Grab the latest APK from [Releases](https://github.com/yourusername/anikai-mobile/releases)
...
```bash
# Clone the repo
git clone https://github.com/yourusername/anikai-mobile.git
cd anikai-mobile
...
Love anime and coding? We'd love your help! Check out [CONTRIBUTING.md](CONTRIBUTING.md) to get started.

## 📄 Legal

This is an unofficial community app. All anime content belongs to their respective owners. Please respect AniKai.to's terms of service.
